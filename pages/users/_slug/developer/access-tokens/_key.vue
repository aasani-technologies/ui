    ...
    <main class="card">
      ...
      <transition name="modal">
        <Confirm v-if="showDelete" :on-close="() => (showDelete = false)">
          ...
          <p>
            Deleting an access token is not reversible, and you'll need to
      ...
      <transition name="modal">
        <Confirm v-if="showUpdate" :on-close="() => (showUpdate = false)">
          ...
          <p>
            Updating your access token will generate a new access token, so
            you'll have to update it wherever you're using it.
          </p>
