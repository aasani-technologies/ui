    ...
    <main class="card">
      ...
      <div v-else>
        ...
        <p>
          ...
          you keep track of what we have and transfer your settings to other
          apps.
        </p>
        ...
        <h2>Delete team</h2>
        <p>
          You can delete your team account. Note that this action is not
        ...
        <transition name="modal">
          <Confirm v-if="showDelete" :on-close="() => (showDelete = false)">
            ...
            <p>
              Deleting a team is not reversible, and all members will be
              removed.
            </p>
