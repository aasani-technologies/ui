    ...
    <main class="card">
      ...
      <div v-else>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    ...
                    <span
                      v-if="subscriptions.data[0].plan.interval_count != 1"
                      >{{ subscriptions.data[0].plan.interval_count }}</span
                    >
        ...
        >
          ...
          <p>
            Create a new subscription for your organization. Your default
            payment method will be charged automatically.
          </p>
